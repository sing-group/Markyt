...
Configure::write('scriptMemoryLimit', '1G');
...
Configure::write('documentsPerPage', 5);
...
Configure::write('annotationsModes', array("MANUAL" => 0, "SEMI-AUTOMATIC" => 1,
      "AUTOMATIC" => 2));
Configure::write('parseIdAttr', "data-id");
Configure::write('allowMultiConecion', true);
 ...
 */
Configure::write('Security.cipherSeed', '76859309657423542496749683645');
