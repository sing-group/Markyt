...
class QuestionsController extends AppController {
    ...
    public function view($id = null) {
        ...
        $answers = $this -> Question -> AnnotationsQuestion -> find('all', array('order' => 'AnnotationsQuestion.annotation_id ASC', 'conditions' => array('AnnotationsQuestion.question_id' => $this -> Question -> id)));
        $this -> set('question', $this -> Question -> find('first', array('contain' => 'Question', 'conditions' => array('User.id' => $id))));
        $answersMap = NULL;
    ...
    public function deleteAll() {
        ...
        if (!$this -> request -> is('post')) {
            ...
            $ids = json_decode($this -> request -> data['allQuestions']);
            $redirect = $this -> Session -> read('redirect');
            $deleteCascade = Configure::read('deleteCascade');
            if ($deleteCascade) {
