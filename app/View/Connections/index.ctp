...
//                            'div' => false));
                    ...
                    <td>
                        <?php
                        if ($connection['Connection']['country'] !== "unknown") {
                            $connection['Connection']['country'] = strtolower($connection['Connection']['country']);
                            ?>
                            <div class="phoca-box">
                                ...
                                <div class="phoca-title">
                                    <?php
                                    echo (country_code_to_country($connection['Connection']['country']));
                                    ?>
                                </div>
                            </div>
                            <?php
                        } else {
                            echo $connection['Connection']['country'];
                        }
                        ?>


                    </td>
                    <td><?php echo $connection['Connection']['city'] ?></td>
                    <td><?php echo $connection['Connection']['ip'] ?></td>
                    <td><?php echo $connection['Connection']['created'] ?></td>
                    <td><?php echo $connection['Connection']['session_time'] ?></td>
