...
<div class="documents index data-table">
    ...
    <table class="table table-hover table-responsive" >
        <thead>
            <tr>
                <th><?php echo $this->Form->input('All', array('type' => 'checkbox',
...
<?php foreach ($documents as $document): ?>
                <tr class="table-item-row">
                    <td class="item-id"><?php
                        echo $this->Form->input('', array('type' => 'checkbox',
                              'value' => $document['Document']['id'], 'class' => 'item',
                              'id' => uniqid(),
                              'div' => false));
                        ?>&nbsp;</td>
                    ...
                    <td class="actions">
                        ...
                        if ($document['Document']['title'] != 'Removing...') {
                            echo $this->Html->link('<i class="fa fa-info-circle"></i>' . __('View'), array(
                                  ...
                                  $document['Document']['id']), array('class' => 'btn btn-primary',
                                  'escape' => false));
                            echo $this->Html->link('<i class="fa fa-pencil-square-o"></i>' . __('Edit'), array(
                                  'controller' => 'documents', 'action' => 'edit',
                                  $document['Document']['id']), array('class' => 'btn btn-warning',
                                  'escape' => false));
                            echo $this->Html->link('<i class="fa fa-trash-o"></i>' . __('Delete'), array(
                                  'controller' => 'documents', 'action' => 'delete',
                                  $document['Document']['id']), array('class' => 'btn btn-danger delete-item table-item',
                                  'escape' => false, "title" => __('Are you sure you want to delete this Document: %s', $document['Document']['title'])));
                        }
                        ?>
                    </td>
                </tr>
    ...
    <div class="col-sm-12">
        <div class="col-sm-4 table-actions">
            ...
            <div class="multiDelete col-sm-6 action">
                <?php
                echo $this->Form->create('documents', array('id' => 'documentsDeleteAll',
                      'class' => 'multiDeleteIndex',
                      'url' => array(
                            'controller' => 'documents', 'action' => 'deleteAll'
                      )
                ));
