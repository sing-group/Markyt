...
<div class="projects form">
    ...
    <fieldset>
        <legend><?php echo __('Settings for get F-score for two annotators'); ?></legend>
        <div>
            <p>In statistics, the <span class="bold">F1 score (also F-score or F-measure)</span> is a measure of a test's accuracy. It considers 
                both the precision and the recalls of the test to compute the score
            </p>
            <p>
