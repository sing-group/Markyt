...
<div class="questions index">
    ...
    <div class="searchDiv">
        <?php 
            ...
            echo $this->Form->input('search',array('value'=>$search,'maxlength'=>'50',"placeholder"=>"",'label'=>'Search: ','class'=>'search'));
	...
	<tr>
            <td><?php   echo $this->Form->input('',array('type'=>'checkbox','value'=>$question['Question']['id'],'class'=>'question')); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			...
			<?php   echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $question['Question']['id']), array('class'=>'deleteAction'), __('Are you sure you want to delete # %s?', $question['Question']['id'])); ?>
		</td>
	</tr>
<?php   endforeach; ?>
	</table>
	...
	<div class="paging ">
	<?php  
        echo $this->Form->create('questions',array('id'=>'questionsDelete','class'=>'multiDeleteIndex','action'=>'deleteAll'));
