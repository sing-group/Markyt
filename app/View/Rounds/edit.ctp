...
echo $this->Html->script('marky-htmlEditable', array(
    'block' => 'scriptInView'));
echo $this->Html->script('Bootstrap/datepicker/js/bootstrap-datepicker', array(
    'block' => 'scriptInView'));
echo $this->Html->css('../js/Bootstrap/datepicker/css/datepicker', array(
    'block' => 'cssInView'));
    ...
    <h1>
        <h1>
            ...
            echo $this->Html->link('<i class="fa fa-eye"></i>', array(
                'action' => 'view',
                $this->request->data['Round']['id']), array(
                'escape' => false));
            ?>
            <?php echo __('Edit Round'); ?>
        </h1>
    </h1>
    <div class="col-md-12">
        <div class="col-md-6">
