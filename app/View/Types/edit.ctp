...
<div class="types form">
    <h1>
        <?php echo $this->Html->link('<i class="fa fa-eye"></i>', array(
              'action' => 'view', $this->request->data['Type']['id']), array('escape' => false)); ?>
<?php echo __('Edit entity type'); ?>
    </h1>
    <div class="col-md-12">
...
<?php
echo $this->Form->input('colour', array('label' => false, 'class' => 'form-control',
      'div' => false, 'id' => 'colour', 'readonly' => "readonly"));
?>
