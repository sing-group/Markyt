...
<div class="types index">
            ...
            <tr>
                <td class="tableId"><?php
                    echo $this->Form->input('', array('type' => 'checkbox',
                          'value' => $type['Type']['id'], 'class' => 'types', 'id' => uniqid()));
                    ?>&nbsp;</td>
                <td>
                    <?php
                    echo $this->Html->link($type['Project']['title'], array(
                          'controller' => 'projects', 'action' => 'view', $type['Project']['id']));
                    ?>
                </td>
                ...
                <td class="actions">
                    ...
                    echo $this->Form->postLink(__('Delete'), array(
                          'action' => 'delete', $type['Type']['id']), array('class' => 'deleteAction'), __('Are you sure you want to delete this Type: %s?', $type['Type']['id']));
                    ?>
                </td>
            </tr>
        <?php endforeach; ?>
    ...
    <div class="multiDelete">
        <?php
        echo $this->Form->create('types', array('id' => 'typesDelete', 'class' => 'multiDeleteIndex',
              'url' => array(
                    'types', 'action' => 'deleteAll'
              ),
        ));
